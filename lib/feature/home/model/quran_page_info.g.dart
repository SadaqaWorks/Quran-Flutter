...
Map<String, dynamic> _$QuranPageInfoToJson(QuranPageInfo instance) =>
    <String, dynamic>{'page_number': instance.pageNumber, 'line_number': instance.lineNumber,
      'sura_number': instance.suraNumber,'ayah_number': instance.ayahNumber,
      'position': instance.position,'min_x': instance.minX,
      'min_y': instance.minY,'max_x': instance.maxX,
      'max_y': instance.maxY};
